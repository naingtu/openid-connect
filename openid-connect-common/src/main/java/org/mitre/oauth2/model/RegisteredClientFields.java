...
public interface RegisteredClientFields {
	...
	public String TOKEN_ENDPOINT_AUTH_SIGNING_ALG = "token_endpoint_auth_sign_alg";
	public String ID_TOKEN_ENCRYPTED_RESPONSE_ENC = "id_token_encr_resp_enc";
	public String ID_TOKEN_ENCRYPTED_RESPONSE_ALG = "id_token_encr_resp_alg";
	public String ID_TOKEN_SIGNED_RESPONSE_ALG = "id_token_signed_resp_alg";
	public String USERINFO_ENCRYPTED_RESPONSE_ENC = "user_info_encr_resp_enc";
	public String USERINFO_ENCRYPTED_RESPONSE_ALG = "user_info_encr_resp_alg";
	public String USERINFO_SIGNED_RESPONSE_ALG = "user_info_signed_resp_alg";
	public String REQUEST_OBJECT_SIGNING_ALG = "request_object_sign_alg";
